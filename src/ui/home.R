    ...
    box(
      ...
      tags$div(
        ...
        tags$h3("Precision Medicine for Pancreatic Cancer Prognosis", 
                style = "color: #0069a7; margin-bottom: 20px;"),
        tags$p("This interactive tool uses gene expression data to predict survival outcomes for pancreatic cancer patients. 
Upload your patient's data to receive personalised risk assessments and prognostic information.",
  ...
  fluidRow(
    box(
      ...
      width = 6,
      tags$div(
        tags$h4("Disease Background", style = "color: #0069a7;"),
...
It's typically diagnosed at advanced stages when surgical intervention is no longer effective."),
        ...
        tags$h4("Clinical Challenge", style = "color: #0069a7; margin-top: 15px;"),
...
to individual patients. Traditional clinical markers alone have limited prognostic value."),
        ...
        tags$h4("Genomic Approach", style = "color: #0069a7; margin-top: 15px;"),
        tags$p("Our model leverages high-throughput gene expression data to identify molecular signatures
associated with survival outcomes, enabling more personalised treatment decisions.")
      )
    ),
    ...
    box(
      ...
      width = 6,
      tags$div(
        tags$h4("Data Source", style = "color: #0069a7;"),
...
clinical outcomes, including survival time and disease status."),
        ...
        tags$h4("Methodology", style = "color: #0069a7; margin-top: 15px;"),
        tags$p("We employed a penalised Cox proportional hazards model (LASSO) to identify gene expression patterns 
most strongly associated with patient survival while avoiding overfitting."),
        
        tags$h4("Validation", style = "color: #0069a7; margin-top: 15px;"),
...
achieving a concordance index (C-index) that significantly outperforms conventional clinical predictors.")
  ...
  fluidRow(
    box(
      ...
      width = 12,
      tags$div(
        tags$h4("Data Sources", style = "color: #0069a7;"),
        ...
        tags$h4("Preprocessing Pipeline", style = "color: #0069a7; margin-top: 15px;"),
        ...
        tags$ol(
          ...
          tags$li("Extraction and standardisation of survival metrics (months survived and mortality status)."),
        ...
        tags$div(
          style = "background-color: #f39c12; color: white; border-left: 5px solid #dbeeff; padding: 10px; margin-top: 15px;",
  ...
  fluidRow(
    box(
      ...
      tags$div(
        ...
        tags$div(
          class = "col-md-4",
          tags$h4("Key Publications", style = "color: 	#0069a7;"),
          tags$ul(
            tags$li(tags$a(
        ...
        tags$div(
          class = "col-md-4",
          tags$h4("Clinical Resources", style = "color: #0069a7;"),
          tags$ul(
        ...
        tags$div(
          class = "col-md-4",
          tags$h4("Technical Documentation", style = "color: #0069a7;"),
          tags$ul(
    ...
    box(
      ...
      tags$div(
        ...
        tags$div(
          ...
          tags$div(
            class = "team-member",
            style = "border-left: 3px solid #0069a7; padding-left: 10px; margin-bottom: 15px;",
            tags$h4("Dylan", style = "margin-top: 0; color: #0069a7;"),
        ...
        tags$div(
          ...
          tags$div(
            class = "team-member",
            style = "border-left: 3px solid #0069a7; padding-left: 10px; margin-bottom: 15px;",
            tags$h4("Howard", style = "margin-top: 0; color: #0069a7;"),
            tags$p("Data Science")
          )
        ),
        # Shuhan
        tags$div(
          ...
          tags$div(
            class = "team-member",
            style = "border-left: 3px solid #0069a7; padding-left: 10px; margin-bottom: 15px;",
            tags$h4("Shuhan", style = "margin-top: 0; color: #0069a7;"),
            tags$p("Data Science")
          )
        ),
        # Cherry
        tags$div(
          ...
          tags$div(
            class = "team-member",
            style = "border-left: 3px solid #0069a7; padding-left: 10px; margin-bottom: 15px;",
            tags$h4("Cherry", style = "margin-top: 0; color: #0069a7;"),
        ...
        tags$div(
          ...
          tags$div(
            class = "team-member",
            style = "border-left: 3px solid #0069a7; padding-left: 10px; margin-bottom: 15px;",
            tags$h4("Ashley", style = "margin-top: 0; color: #0069a7;"),
            tags$p("Data Science")
          )
        ),
        # Zhantao
        tags$div(
          ...
          tags$div(
            class = "team-member",
            style = "border-left: 3px solid #0069a7; padding-left: 10px; margin-bottom: 15px;",
            tags$h4("Zhantao", style = "margin-top: 0; color: #0069a7;"),
