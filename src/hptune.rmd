...
# Save the best overall model (choose based on your preferred metric)
# Here we're using the C-index model as default
final_model <- model_results$cindex$model
saveRDS(final_model, "final_coxboost_model.rds")
message("\n[INFO]: Final model saved as 'final_coxboost_model.rds'")
```